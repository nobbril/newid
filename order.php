...
if ($data['code'] == 'ok') {
    ...
    <div class="container">
        <h2 class="success-page__title">Selamat! Pesanan Anda telah diterima!</h2>

        <p class="success-page__message_success">Selanjutnya, operator pusat layanan informasi kami akan segera menghubungi Anda untuk mengkonfirmasi pesanan Anda. Pastikan ponsel Anda dalam kondisi aktif.</p>

        <h3 class="success-page__text">Silakan periksa informasi yang telah Anda masukkan</h3>

        <div class="list-info">
            <ul class="list-info__list">
                <li class="list-info__item">
                    <span class="list-info__text">Nama dan nama Akhir Anda.: </span>
                    $name
                </li>
                <li class="list-info__item">
                    <span class="list-info__text">Telepon: </span>
                    $phone
                </li>
            </ul>
        </div>
        ...
        <p class="success-page__message_fail">
            <a class="success-page__message_fail__link" href="#" onclick="GoBackWithRefresh();return false;">
                Apabila Anda membuat kesalahan dalam pengisian formulir, silakan kembali dan mengisi ulang
            </a>
        </p>
    </div>
</div>
